...
$service = substr($service,0,-5) . 'judgement';
// echo $service; die();
// Get last messages for each team / episode.


function getJudgements( $service, $key){
